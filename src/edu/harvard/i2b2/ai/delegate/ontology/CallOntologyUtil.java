 ...
 ******************************************************************************/
 ...
 package edu.harvard.i2b2.ai.delegate.ontology;
...
//import edu.harvard.i2b2.ai.datavo.AIJAXBUtil;
...
import edu.harvard.i2b2.ai.datavo.ontology.DeleteChildType;
import edu.harvard.i2b2.ai.datavo.ontology.DerivedFactColumnsType;
import edu.harvard.i2b2.ai.datavo.ontology.GetChildrenType;
import edu.harvard.i2b2.ai.datavo.ontology.GetModifierInfoType;
import edu.harvard.i2b2.ai.datavo.ontology.GetTermInfoType;
import edu.harvard.i2b2.ai.datavo.ontology.MatchStrType;
import edu.harvard.i2b2.ai.datavo.ontology.MetadataLoadType;
import edu.harvard.i2b2.ai.datavo.ontology.ModifierType;
import edu.harvard.i2b2.ai.datavo.ontology.ModifiersType;
import edu.harvard.i2b2.ai.datavo.ontology.ObjectFactory;
import edu.harvard.i2b2.ai.datavo.ontology.OntologyDataType;
...
public class CallOntologyUtil {
	...
	private static JAXBUtil jaxbUtil =   AIJAXBUtil.getJAXBUtil();


	public static ConceptsType callOntology(String itemKey, String strategy, SecurityType securityType,  String category, String projectId, String ontologyUrl ) throws Exception {
		RequestMessageType requestMessageType = getI2B2RequestMessage(itemKey, strategy, category, securityType, projectId.replaceAll("/", ""));
	...
	private static RequestMessageType getI2B2RequestMessage(String conceptPath, String strategy, String category, SecurityType securityType,  String projectId ) {
		...
		// build message body
		MatchStrType matchStr = new MatchStrType();
		matchStr.setValue(conceptPath);
		matchStr.setStrategy(strategy);
		
		VocabRequestType vocal = new VocabRequestType();
		vocal.setCategory(category);
		vocal.setMatchStr(matchStr);
		vocal.setSynonyms(true);
		vocal.setHiddens(false);
		vocal.setType("core");
		vocal.setBlob(false);
	...
	private static ConceptsType getConceptsFromResponse(String response)
